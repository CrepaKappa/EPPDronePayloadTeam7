...
model.FaceBC(1) = faceBC(Constraint="fixed"); % Fixed to drone body
...
model.FaceLoad(10) = faceLoad("SurfaceTraction",[0,0,-weightTraction]); % Weight of motor
model.FaceLoad(7) = faceLoad("SurfaceTraction",[0,0,thrustTraction]); % Force of propeller pull
...
massModel = createpde;
importGeometry(massModel,"DroneArmC.STL");
