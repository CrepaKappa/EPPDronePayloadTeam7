...
alignmentArea = pi*(0.005)^2; % drone arm models will have a slightly inset face of negligible depth to assist in proper alignment of forces
weightTraction = weight/alignmentArea;
thrustTraction = thrust/alignmentArea;

model.FaceLoad(7) = faceLoad("SurfaceTraction",[0,0,-weightTraction]); % Weight of motor
...
massModel = createpde;
importGeometry(massModel,"DroneArmA.STL");
